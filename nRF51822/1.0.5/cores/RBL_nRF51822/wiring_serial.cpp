...
{
	uint16_t i = ( uint16_t )( rxbuffer.rx_Head +1 ) % SERIAL_BUFFER_MAX_SIZE;
...
{
	return (uint16_t)(SERIAL_BUFFER_MAX_SIZE + rxbuffer.rx_Head - rxbuffer.rx_Tail) % SERIAL_BUFFER_MAX_SIZE;
}
